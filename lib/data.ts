...
} from "./creatives.generated";

export { criativosAudienciaTodos, criativosMensagensTodos };
export type { CriativoAudiencia, CriativoMensagens };
...
// Top criativos (derivados dos exports em data/)
export const criativosAudiencia: ReadonlyArray<CriativoAudiencia> = [...criativosAudienciaTodos]
  .sort((a, b) => b.ctr - a.ctr)
  .slice(0, 10);

export const criativosMensagens: ReadonlyArray<CriativoMensagens> = [...criativosMensagensTodos]
...
export const estatisticasHero = {
  ...
  criativosAnalisados: criativosAudienciaTodos.length + criativosMensagensTodos.length,
  mesesAnalisados: 6,
};
